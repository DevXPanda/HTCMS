...
router.get('/inspector/stats', protect, authorize('inspector', 'admin', 'SBM'), getInspectorStats);
router.get('/activity', protect, authorize('collector', 'inspector', 'admin', 'SBM'), getD2DCActivity);
...
router.get('/demands', protect, authorize('inspector', 'admin', 'SBM'), getD2DCDemands);
router.get('/payments', protect, authorize('inspector', 'admin', 'SBM'), getD2DCPayments);
