...
const ActivityLogs = () => {
  ...
  const getActionStyle = (actionType) => {
    const styles = {
      ...
      ASSIGN: { badge: 'bg-amber-100 text-amber-800 border-amber-200', border: 'border-l-amber-500' }
    };
    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="ds-page-header">
        <div>
          ...
          <p className="ds-page-subtitle">Activity related to your assigned wards</p>
        </div>
        <button
          type="button"
      ...
      {auditLogs.length === 0 ? (
        <div className="card rounded-xl border border-gray-100 text-center py-14">
          ...
          <p className="text-gray-500 text-sm">No activity logs found for your assigned wards.</p>
        </div>
      ) : (
            ...
            return (
              ...
              >
                <div className="flex flex-wrap items-center gap-2 gap-y-1 mb-2">
                  ...
                  {actorName && (
                    <span className="text-sm text-gray-500">by {actorName}</span>
                  )}
