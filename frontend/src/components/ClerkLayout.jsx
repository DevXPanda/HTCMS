                ...
                <header className="no-print bg-white shadow-sm sticky top-0 z-10 w-full">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <StaffPortalHeaderRow
                                ...
                                userTitle={userData?.firstName || userData?.full_name || 'Clerk'}
                                ...
                                <div className="flex items-center space-x-4 mb-6">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-medium text-gray-900">
                                            {userData?.firstName || userData?.full_name || 'Clerk'}
                                        </h4>
                                        <p className="text-sm text-gray-500 capitalize">{userData?.role || 'clerk'}</p>
                                    </div>
                                </div>
