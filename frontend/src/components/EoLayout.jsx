...
const EoLayout = () => {
  ...
  const isDashboard = location.pathname === '/eo/dashboard';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              <div className="flex items-center gap-4">
                <h1 className="text-xl font-bold text-primary-600">Field Worker Monitoring</h1>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="hidden md:flex items-center space-x-3 px-3 py-1.5 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <div className="flex flex-col">
                    <span className="text-xs font-semibold text-gray-900">{userData?.full_name || 'EO'}</span>
