        ...
        <header className="no-print bg-white shadow-sm sticky top-0 z-10 w-full">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <StaffPortalHeaderRow
              searchRole="eo"
              dashboardPath="/eo/dashboard"
              userInitial={userData?.full_name?.charAt(0) || userData?.firstName?.charAt(0) || 'E'}
              userTitle={userData?.full_name || userData?.firstName || 'EO'}
                ...
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <div>
                    <h4 className="text-lg font-medium text-gray-900">
                      {userData?.full_name || userData?.firstName || 'EO'}
                    </h4>
                    <p className="text-sm text-gray-500 capitalize">{userData?.role || 'eo'}</p>
                  </div>
                </div>
