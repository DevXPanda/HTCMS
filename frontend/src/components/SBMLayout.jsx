              ...
              <div className="layout-header-actions">
                ...
                <div className="hidden md:flex items-center space-x-3 px-3 py-1.5 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <div className="flex flex-col">
                    <span className="text-xs font-semibold text-gray-900">{userData?.full_name || userData?.firstName || 'SBM'}</span>
                    <span className="text-xs text-gray-500">ID: {userData?.employee_id || userData?.id || 'N/A'}</span>
                    {userData?.full_crud_enabled && (
                      <span className="text-[10px] text-primary-600 mt-0.5">Full CRUD</span>
                    )}
                  </div>
                </div>
                <button
